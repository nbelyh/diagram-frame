define([], () => {
  return {
    ...
    LinkFileInstructions: "Paste a link",
    LinkHeader: "Add a link",
    ...
    ODPhotoIconUrl: "https://modernb.akamai.odsp.cdn.office.net/files/fabric-cdn-prod_20210703.001/assets/item-types/16/photo.png",
    ODRowArialLabelTemplate: "{0}, {1}, Modified {2}, edited by {3}, {4}, {5}",
    OneDriveConfirmDialogBody: "This item is from your OneDrive site. Files in OneDrive are private. If you continue a fixed copy of this file will be created in the current Site Assets library so that others can access it. Do you want this file to be copied?",
    OneDriveConfirmDialogTitle: "Copy file from OneDrive...",
    ...
    OneDriveEmptyFolderIconUrl: "https://modernb.akamai.odsp.cdn.office.net/files/fabric-cdn-prod_20210703.001/office-ui-fabric-react-assets/images/emptyfolder/empty_filter.svg",
