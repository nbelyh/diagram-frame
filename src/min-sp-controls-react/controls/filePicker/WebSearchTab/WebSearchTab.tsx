        ...
        <Label>{strings.PoweredByBing}</Label>
        {
          ...
          <div className={styles.dropdownContainer}>
            <Dropdown
              ...
              onChange={(_, option: IDropdownOption) => this._handleChangeSize(option)}
            />
            <Dropdown
              className={styles.filterDropdown}
              onRenderPlaceholder={(props: IDropdownProps) => this._renderFilterPlaceholder(props)}
              ...
              onChange={(_, option: IDropdownOption) => this._handleChangeLayout(option)}
            />
            <Dropdown
              className={styles.filterDropdown}
              onRenderPlaceholder={(props: IDropdownProps) => this._renderFilterPlaceholder(props)}
              ...
              onChange={(_, option: IDropdownOption) => this._handleChangeLicense(option)}
            />
          </div>
        }
      </div>);
